...
if (isset($_POST['updateprofile'])) {
    ...
    $user_programme = escape($_POST['programme']);
    ...
    $query .= "user_programme = '$user_programme', ";
    $query .= "user_intake = '$user_intake', ";
    $query .= "user_emergency_contact = '$user_emergency_contact' ";
    $query .= "WHERE user_id = $user_id";

    $update_profile_query = mysqli_query($connection, $query);
    if ($update_profile_query){
        echo "<script>alert('Your profile has been updated successfully.');window.location='profile_student.php'</script>";
    } else {
                    ...
                    <section class="profile">
                        ...
                        <div class="profile__form-box">
                            <form class="update-profile-form" action="" method="post" autocomplete="off">
                                ...
                                <div class="form-row">
                                    <label for="programme" class="profile__form-label">Pre-U Programmes (Only applicable for student)</label>
                                    <input
                                        type="text"
                                        name="programme"
                                        class="programme"
                                        id="programme"
                                        value="<?php if (isset($user_programme)) {echo $user_programme; } ?>"
                                        readonly
                                    />
                                </div>

                                <div class="form-row">
                                    <label for="intake" class="profile__form-label">Intake / Semester (Only applicable for student)</label>
                                    <input
                                        type="month"
                                        name="intake"
                                        class="intake"
                                        id="intake"
                                        value="<?php if (isset($user_intake)) {echo $user_intake; } ?>"
                                        readonly
                                    />
                                </div>

                                <div class="form-row">
                                    <label for="emergencycontact" class="profile__form-label">Emergency Contact (Only applicable for student)</label>
                                    <input
                                        type="number"
                                        name="emergencycontact"
                                        class="emergencycontact"
                                        id="emergencycontact"
                                        value="<?php if (isset($user_emergency_contact)) {echo $user_emergency_contact; } ?>"
                                        required
                                    />
                                </div>
