                    ...
                    <section class="hero">
                        ...
                        <div class="hero__info-box">
                            <div class="hero__course">
                                <h2 class="heading-secondary">Course</h2>
                                <a
                                    href="course_student.php"
                            ...
                            <div class="hero__result">
                                <h2 class="heading-secondary">Result</h2>
                                <a
                                    href="result_student.php"
                                    class="hero__detail-link"
                                    >View Details &rarr;</a
                                >
                                <i class="fa-solid fa-square-poll-vertical hero__icon"></i>
                            </div>
                            <div class="hero__notice">
                                <h2 class="heading-secondary">Notice</h2>
                                <a
                                    href="notice_student.php"
                                    class="hero__detail-link"
                                    >View Details &rarr;</a
                                >
                                <i class="fa-solid fa-note-sticky hero__icon"></i>
                            </div>
                        </div>
