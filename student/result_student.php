...
<html lang="en">
    <head>
        ...
        <title>Student Result | EduTrack</title>
    </head>
    <body>
        <div class="container">
            ...
            <div class="dashboard">
                ...
                <main class="content">
                    <section class="course">
                        ...
                        <h2 class="heading-secondary">Modules Result:</h2>
                            ...
                            <tbody>
                                ...
                                if (mysqli_num_rows($user_modules_query) > 0) {
                                    while ($row = mysqli_fetch_assoc($user_modules_query)) {
                                        ...
                                        $module_result_row = mysqli_fetch_assoc($module_query);
                                        if ($module_result_row) {
                                            $result_score = $module_result_row['result_score'];
                                        } else {
                                            $result_score = "Not yet released";
                                        }
                                ...
                                <tr>
                                    ...
                                    <td data-cell="status"><?php echo $result_score; ?></td>
                                </tr>
